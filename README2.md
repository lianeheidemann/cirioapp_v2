...
<details>
<summary><strong><code>.env</code> file not found</strong></summary>
...
<details>
<summary><strong>Gemini assistant reports a missing key</strong></summary>
...
<details>
<summary><strong>Firebase initialization fails</strong></summary>
...
<details>
<summary><strong>Tests fail because configuration is missing</strong></summary>
...
1. Check for a related issue or open one describing the change.
2. Run `dart analyze` and `flutter test` locally.
3. Clearly describe what changed and why in the pull request body.
