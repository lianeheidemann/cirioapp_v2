...
News is read from the `news` collection. Notifications use the `cirio_updates` FCM topic. See [docs/firestore_news.md](../firestore_news.md) for the schema and publishing workflow.
